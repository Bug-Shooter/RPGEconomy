...
public interface IBuildingService
{
    ...
    Task<Result<BuildingDto>> CreateAsync(int settlementId, string name, int recipeId, int workerCount);
    Task<Result<BuildingDto>> UpdateAsync(int id, string name, int workerCount);
